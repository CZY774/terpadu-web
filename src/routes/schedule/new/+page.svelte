	...
	<form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }} class="space-y-6">
		...
		<div>
			...
			<div class="grid grid-cols-2 gap-3">
				<button type="button" class="py-4 bg-gray-300 text-[#2E3192] font-bold rounded-full" onclick={() => reminder = '30'}>30 MINUTE</button>
				<button type="button" class="py-4 bg-gray-300 text-[#2E3192] font-bold rounded-full" onclick={() => reminder = '15'}>15 MINUTE</button>
				<button type="button" class="py-4 bg-gray-300 text-[#2E3192] font-bold rounded-full" onclick={() => reminder = '60'}>1 HOUR</button>
				<button type="button" class="py-4 bg-gray-300 text-[#2E3192] font-bold rounded-full" onclick={() => reminder = '1440'}>1 DAY</button>
			</div>
		</div>
		...
		<div>
			...
			<div class="flex gap-4 justify-center flex-wrap">
				<button type="button" class="w-24 h-24 bg-[#C4D82E] rounded-[2rem] flex items-center justify-center" onclick={() => selectedCategory = 'book'}>
		...
		<div class="flex gap-4 pt-4">
			...
			<button type="button" onclick={() => goto('/schedule')} class="flex-1 py-5 bg-gray-300 text-[#2E3192] font-bold rounded-full text-lg">Cancel</button>
		</div>
	</form>
</div>
